...
namespace core {
    ...
    let instructions: scenes.Instruction;
    ...
    let assetData:objects.Asset[] = [
        ...
        { id: "berry", src: "../../Assets/images/berry.png" },
        { id: "player", src: "../../Assets/images/player.png" },
        { id: "enemy", src: "../../Assets/images/enemy.png" },
        { id: "roadCoy", src: "../../Assets/images/roadCoy.png" },
        { id: "meep", src: "../../Assets/audio/meep.mp3" },
        { id: "hurt", src: "../../Assets/audio/hurt.mp3" },
        { id: "run", src: "../../Assets/audio/run.mp3" },
    ...
    export function changeScene(): void {
        ...
        switch (scene) {
            ...
            case config.Scene.INSTRUCTIONS:
                stage.removeAllChildren();
                instructions = new scenes.Instruction();
